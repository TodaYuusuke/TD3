...
/// パーティクル
/// </summary>
class SoilSplashParticle : public LWP::Object::Particle<LWP::Resource::Cube> {
private: // ** 純粋仮想関数のオーバーライド ** //

	LWP::Math::Vector3 destinate;
	...
	void Generate(Data& newData) override {
		newData.m.worldTF.translation = lwp::Vector3{ 0,1,0 } + model.worldTF.GetWorldPosition();
		// 大きさをランダムにする
		...
		// 発射のベクトル
		LWP::Math::Vector3 dir{ dir1 / 100.0f + -destinate.x,dir2 / 100.0f + -destinate.y, dir3 / 100.0f + -destinate.z };
		// 係数
