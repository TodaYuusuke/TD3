...
void Weapon::Initialize()
{
	...
	demoModel_.worldTF.translation.z = 1.0f;
	demoModel_.worldTF.scale = { 0.5f,0.5f,0.8f };
...
{
	rootData_.translate_.start_ = demoModel_.worldTF.translation;
...
{
	momentData_.scale_.start_ = demoModel_.worldTF.scale;
	//momentData_.rotate_.start_ = demoModel_.transform.rotation;
	momentData_.translate_.start_ = demoModel_.worldTF.translation;
}

void Weapon::UpdateRoot()
{
	demoModel_.worldTF.scale = lwp::Vector3::Slerp(rootData_.scale_.start_, rootData_.scale_.end_, *pT_);
	demoModel_.worldTF.rotation = lwp::Vector3::Slerp(rootData_.rotate_.start_, rootData_.rotate_.end_, *pT_);
	demoModel_.worldTF.translation = lwp::Vector3::Slerp(rootData_.translate_.start_, rootData_.translate_.end_, *pT_);
}

void Weapon::UpdateSlash()
{
	demoModel_.worldTF.scale = lwp::Vector3::Slerp(slashData_.scale_.start_, slashData_.scale_.end_, *pT_);
	demoModel_.worldTF.rotation = lwp::Vector3::Slerp(slashData_.rotate_.start_, slashData_.rotate_.end_, *pT_);
	demoModel_.worldTF.translation = lwp::Vector3::Slerp(slashData_.translate_.start_, slashData_.translate_.end_, *pT_);
}

void Weapon::UpdateMoment()
{
	demoModel_.worldTF.scale = lwp::Vector3::Slerp(momentData_.scale_.start_, momentData_.scale_.end_, *pT_);
	demoModel_.worldTF.rotation = lwp::Vector3::Slerp(momentData_.rotate_.start_, momentData_.rotate_.end_, *pT_);
	demoModel_.worldTF.translation = lwp::Vector3::Slerp(momentData_.translate_.start_, momentData_.translate_.end_, *pT_);
}
