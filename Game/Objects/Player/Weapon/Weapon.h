...
public:	//*** セッター,ゲッター ***//
	...
	lwp::TransformEuler* GetWorldTransform() { return &demoModel_.worldTF; }
	void SetParent(lwp::TransformEuler* p) { demoModel_.worldTF.Parent(p); }
	...
	// 武器のモデル取得
	lwp::RigidModel* GetMesh() { return &demoModel_; }
